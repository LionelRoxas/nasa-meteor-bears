...
// Dynamically import Cesium Earth to avoid SSR issues
const CesiumEarth = dynamic(() => import("@/components/cesium/CesiumEarth"), {
  ssr: false,
...
export default function CesiumMapTest() {
  ...
  const handleStartImpact = () => {
    if (!isSimulating && !countdown) {
      ...
      setShowImpactZones(true);
    } else {
      setIsSimulating(false);
      setCountdown(null);
      setIsSidebarCollapsed(false);
      setShowNASAPanel(wasNASAPanelOpen);
      setShowImpactZones(false);
    }
  };
